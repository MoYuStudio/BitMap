...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/your-username/BitMap)
...
- **程序化地形生成**: 使用噪声算法生成包含海洋、陆地、草地、石头、雪地等多种地形的像素地图
...
```gdscript
const MAP_WIDTH = 128   # 地图宽度
const MAP_HEIGHT = 128  # 地图高度
```
