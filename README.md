...
[![Version](https://img.shields.io/badge/version-2.0.0-blue.svg)](https://github.com/your-username/BitMap)
...
- **铁路网络**: 可以绘制连接城市之间的铁路线路
- **多种建造模式**: 提供点击模式、绘制模式和铁路模式三种不同的建造方式
- **实时预览**: 铁路绘制时提供实时预览功能
...
*📅 **截图时间**: 2024年12月*  
*🏷️ **版本**: v2.0.0*  
*🎮 **功能展示**: 最新版本展示了改进的地形生成系统，包含8级高度图（深海、深水、浅水、海岸、平原、丘陵、山地、高山）。地图尺寸扩展到256x256，提供更广阔的建造空间。城市网络更加密集，包含平阳、崇明、建业、嵊泗、陈留、潜山、蓟门、舒城、庐州、泰州、青田、金陵、嘉兴、酒泉、寿春、无锡等城市，通过复杂的铁路网络相互连接。*
